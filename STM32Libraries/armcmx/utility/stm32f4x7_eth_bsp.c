...
/* Ethernet pins configuration ************************************************/
   /* Open407V-C Ethernet board
        ...
        ETH_MII_TXD1/ETH_RMII_TXD1 -------> PB13 // PG14
                                                  */
   /*  Olimex STM E407 (Micrel KS8721BL PHY)
        ETH_MDIO -------------------------> PA2
        ETH_MDC --------------------------> PC1
        ETH_PPS_OUT ----------------------> NC //PB5
        ETH_MII_CRS ----------------------> GND //PH2
        ETH_MII_COL ----------------------> GND //PH3
        ETH_MII_RX_ER --------------------> NC //PI10
        ETH_MII_RXD2 ---------------------> GND //PH6
        ETH_MII_RXD3 ---------------------> GND //PH7
        ETH_MII_TX_CLK -------------------> PA1(D8) //PC3
        ETH_MII_TXD2 ---------------------> GND //PC2
        ETH_MII_TXD3 ---------------------> GND //PB8
        ETH_MII_RX_CLK/ETH_RMII_REF_CLK---> NC (REFCLK is merged with TXC)
        ETH_MII_RX_DV/ETH_RMII_CRS_DV ----> PA7(D11)
        ETH_MII_RXD0/ETH_RMII_RXD0 -------> PC4
        ETH_MII_RXD1/ETH_RMII_RXD1 -------> PC5
...
#elif defined(USE_OPEN407VC) || defined (USE_STM_E407)
...
#if defined (USE_STM324xG_EVAL) || defined (USE_STM_E407)
